...
public class ProjectTask {
  ...
  /*@Test
  public void TaskAllocation() throws Exception {
	  projectView.project();
	  //Global.clickWhenReady(By.xpath(Global.prop.getProperty("PrjTaskTab")));
	  Global.driver.switchTo().window(Global.driver.getWindowHandles().toArray()[1].toString());
	  Global.driver.findElement(By.xpath(Global.prop.getProperty("prjTaskTab"))).click();
  ...
  @Test
  public void LineupTaskAllocation() throws Exception {
	 ...
	 /* Global.driver.findElement(By.xpath(Global.prop.getProperty("assigntoNew"))).click();
	  //Global.driver.findElement(By.xpath(Global.prop.getProperty("dDJSAdmin"))).click();
	  Global.clickWhenReady(By.xpath(Global.prop.getProperty("dDJSAdmin")));
	  Global.clickWhenReady(By.xpath(Global.prop.getProperty("bTNViewTask")));
