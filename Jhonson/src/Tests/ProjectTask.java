...
public class ProjectTask {
	...
	public void LineupReviewTask() throws Throwable {
		...
		//WebElement uploadElement = Global.driver.findElement(By.xpath(Global.prop.getProperty("fileUpload")));
		// Provide the full file path (PDF file)
       // uploadElement.sendKeys(".//Docs//doc1.pdf");
